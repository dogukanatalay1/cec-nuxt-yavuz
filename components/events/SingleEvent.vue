            ...
            <div class="postpage_content_wrapper">
              <div class="social_wrapper">
                ...
                <ul class="social_items list-unstyled">
                  <li>
                    <a href="#"><i class="fab fa-facebook-f fb_icon" /></a>
                  </li>
                  <li>
                    <a href="#"><i class="fab fa-twitter tw_icon" /></a>
                  </li>
                  <li>
                    <a href="#"><i class="fab fa-linkedin-in link_icon" /></a>
                  </li>
                  <li>
                    <a href="#"><i class="fab fa-instagram in_icon" /></a>
                  </li>
                </ul>
              </div>
              <div class="blog_post_content">
                ...
                <p class="quite_speech">
                  <i class="fa fa-quote-right" />Vestibulum ante ipsum primis in
                  faucibus orci luctus et ultrices posuere cubilia Curae id
                  efficitur condimentum, dui nisl ullamcorper diam, at molestie
                  nulla erat gna.
                </p>
                <p>
                  At vero eos et accusamus et iusto odio dignissimos ducimus qui
                ...
                <div class="post_response_count d-flex justify-content-between">
                  ...
                  <ul class="d-flex comnent_count">
                    <li><i class="fas fa-thumbs-up" />3 Likes</li>
                    <li><i class="fas fa-comment" />2 Comments</li>
                  </ul>
                </div>
